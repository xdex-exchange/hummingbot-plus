...
class AbPerpetualUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        if self._ws_assistant is None:
            ...
            subaccount_id = f"{self._connector._ab_perpetual_chain_address}/{self._connector.subaccount_id}"

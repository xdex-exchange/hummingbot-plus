...
from hummingbot.connector.derivative.ab_perpetual import ab_perpetual_constants as CONSTANTS
from hummingbot.connector.derivative.ab_perpetual.data_sources.keypairs import PrivateKey
from hummingbot.connector.derivative.ab_perpetual.data_sources.tx import SigningCfg, Transaction


class AbPerpetualClient:
    def __init__(
            self,
            secret_phrase: str,
